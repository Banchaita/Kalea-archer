...
import { getDesignerOrderList } from '../../actions/orderlist'
...
const DesignerorderDetails = () => {
    ...
    const designerorderData = useSelector(state => state.orderlist.designerorder_data)

    const orderList = () => {
        toast.success(' Successful')
        dispatch(getDesignerOrderList())
    }
    return (
        <>
            <Sidebar />
